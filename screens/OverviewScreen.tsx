				...
				{order.type == "BUY" && (
					<>
						...
						>
							...
							<View style={{ height: 5 }} />
							<Text category="p2">
								Kindly make a payment of your buying amount to
								the account details provided below. Your
								cryptocurrency will be released into your
								receiving address only when payment has been
								...
								>
									...
									<TouchableOpacity
										...
										onPress={async () => {
											...
											alert.success(
												`${order.bankName} Account Number Copied`
											);
										}}
									>
										<Icon
				...
				{order.type == "SELL" && (
					<>
						...
						>
							...
							<View style={{ height: 5 }} />
							<Text category="p2">
								Kindly make a payment of your selling amount to
								the address provided below. Your payment will be
								released to your bank account once your crypto
								has received at least one blockchain
								confirmation.
							</Text>
						</View>
						...
						<View style={{ paddingHorizontal: 15 }}>
							...
							<View style={{ paddingVertical: 15 }}>
								...
								{order.memoTag ? (
									<>
										<Text category="h6">
											{order.currency} Address Memo/Tag
										</Text>
										<Text category="s1">
											{order.memoTag}
										</Text>
