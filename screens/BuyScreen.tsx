		...
		<ModalContainer>
			...
			>
				...
				<View style={{ paddingHorizontal: 15, paddingVertical: 25 }}>
					...
					<Text category="p2">
						Kindly provide the account you'd be paying with. Please
						note that the payment must be done using the account
						provided below only. Payment from another account would
						not be regarded as payment for this transaction.
					</Text>
				</View>
